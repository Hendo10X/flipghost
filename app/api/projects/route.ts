...
export async function POST(request: Request) {
  ...
  // Stored in the audio_track text column as a JSON array of clips.
  const audioClipsStr = Array.isArray(body.audioClips)
    ? JSON.stringify(body.audioClips)
    : null
