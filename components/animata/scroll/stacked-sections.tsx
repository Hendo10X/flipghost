...
export default function StackedSections({
  ...
  // The ref arrays deliberately aren't trimmed here: mutating a ref during
  // render is unsafe, and React nulls out entries for unmounted panes anyway.
  // Every read below is bounded by `total` or null-guarded.
  ...
  React.useEffect(() => {
    ...
    // Captured for cleanup: contentRefs.current may point elsewhere by then.
